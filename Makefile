...
build-bin:
	...
	pyinstaller --name $(BIN_NAME) --onefile --noconsole $(ENTRY_POINT) --add-data "src/assets/omixforge.png:src/assets"
...
build-deb:
	...
	echo "Maintainer: Sinan <you@example.com>" >> $(BUILD_DIR)/DEBIAN/control
