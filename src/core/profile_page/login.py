...
class Login():
    ...
    def __init__(self, main_layout, parent_page):
        ...
        self.error_label = QLabel("Invalid username or password")
        ...
        self.parent.login_error_label = self.error_label
        

        self.login_btn = QPushButton("Login")
        self.login_btn.setObjectName("loginButton")
        self.login_btn.clicked.connect(self.parent.attempt_login)
